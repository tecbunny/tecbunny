    ...
    <div className="space-y-6">
      ...
      {showAdvanceModal && selectedQuote && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
          <Card className="w-full max-w-2xl border-white/10 bg-[#030712]">
            <CardHeader className="border-b border-white/10">
              <CardTitle className="text-white">Set Advance Payment</CardTitle>
            </CardHeader>
            <CardContent className="pt-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
              ...
              <div className="space-y-4">
                <div>
                  <Label className="text-slate-300 mb-2 block">Advance Amount (₹)</Label>
                  <Input 
                    type="number" 
                    value={advanceAmount} 
                  ...
                  />
                  <p className="text-xs text-slate-500 mt-1\">Typically 50-60% of total amount</p>
                </div>

                <div>
                  <Label className="text-slate-300 mb-2 block">Payment Method</Label>
                  <div className="flex gap-3">
                    <Button 
                      variant={paymentMethod === 'payu' ? 'default' : 'outline'}
                      onClick={() => setPaymentMethod('payu')}
                      className={paymentMethod === 'payu' ? 'bg-cyan-600 hover:bg-cyan-700' : 'border-white/20'}
                    >
                      PayU Online
                    </Button>
                    <Button 
                      ...
                      className={paymentMethod === 'wire_transfer' ? 'bg-cyan-600 hover:bg-cyan-700' : 'border-white/20'}
                    >
                      Wire Transfer
                    </Button>
                  </div>
                ...
                <div>
                  <Label className="text-slate-300 mb-2 block">Payment Terms & Conditions</Label>
                  <textarea 
                    value={clauses} 
                    onChange={e => setClauses(e.target.value)}
                    rows={3}
