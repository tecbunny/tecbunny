...
export default function AboutPage() {
  return (
    <div className="relative overflow-hidden bg-[#09090B] text-slate-200">
      ...
      <section className="border-t border-white/10 bg-white/5 py-16">
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 px-4 text-center sm:px-6 md:grid-cols-3 lg:px-8">
          ...
          <div className="rounded-2xl border border-white/10 bg-zinc-900/60 p-6">
            ...
            <Link href="/contact" className="mt-3 inline-block text-xs font-semibold text-primary">
              Get in touch →
            </Link>
          </div>
        </div>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-6 text-center">
              ...
              <a
                ...
                className="mt-5 inline-flex items-center justify-center rounded-lg bg-primary hover:bg-primary/90 px-5 py-2 text-sm font-semibold text-white transition-colors"
              >
                Chat Now
              </a>
            </div>
