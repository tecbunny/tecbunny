      ...
      <section className="border-y border-white/5 bg-white/5 py-16">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div className="relative">
            <div className="absolute -inset-4 rounded-2xl bg-gradient-to-r from-cyan-500/40 to-cyan-500/10 opacity-20 blur-2xl" />
            <div className="relative rounded-2xl border border-white/10 bg-zinc-900/70 p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-cyan-500/10 text-cyan-300">🏠</div>
              <div>
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-6">
              <div className="flex items-center gap-6">
                <div className="flex h-24 w-24 items-center justify-center rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-cyan-500/20 to-cyan-500/10 text-2xl font-bold text-cyan-300 font-tech shadow-lg shadow-cyan-500/5">
                  SB
                </div>
                <div>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-6 text-center">
              ...
              <a
                ...
                className="mt-5 inline-flex items-center justify-center rounded-lg bg-cyan-500 hover:bg-cyan-400 px-5 py-2 text-sm font-semibold text-slate-900 transition-colors"
              >
                Chat Now
              </a>
            </div>
            <div className="rounded-2xl border border-white/10 bg-zinc-900/70 p-6 text-center">
              ...
              <a
                ...
                className="mt-5 inline-flex items-center justify-center rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 px-5 py-2 text-sm font-semibold text-white transition-colors"
              >
                Send Email
              </a>
            </div>
      ...
      <section className="bg-zinc-900/50 py-16 text-center">
        <div className="mx-auto max-w-4xl px-4 sm:px-6">
          ...
          <div className="mt-6 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link href="/products" className="rounded-lg bg-cyan-500 hover:bg-cyan-400 px-6 py-3 text-sm font-semibold text-slate-900 transition-colors">
              Shop Now
            </Link>
            <Link href="/contact" className="rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 px-6 py-3 text-sm font-semibold text-white transition-colors">
              Contact Us
            </Link>
          </div>
        </div>
